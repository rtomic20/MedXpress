...
class ProfilPagePacient extends StatefulWidget {
  ...
  @override
  State<ProfilPagePacient> createState() => _ProfilPagePacientState();
}

class _ProfilPagePacientState extends State<ProfilPagePacient> {
  late String _ime;
  ...
  Future<void> _openChangePasswordDialog() async {
    ...
    // >>>>>>>>>>>> KLJUČNO: varijable izvan StatefulBuilder.builder-a <<<<<<<<<<<<
